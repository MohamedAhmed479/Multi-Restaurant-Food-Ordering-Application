                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="group_name" class="form-select">
                                                    ...
                                                    <option value="Category"
                                                        ...
                                                        Category</option>
                                                    <option value="City"
                                                        {{ $permission->group_name == 'City' ? 'selected' : '' }}>City
                                                    </option>
                                                    <option value="Product"
                                                        {{ $permission->group_name == 'Product' ? 'selected' : '' }}>Product
                                                    </option>
                                                    <option value="Restaurant"
                                                        {{ $permission->group_name == 'Restaurant' ? 'selected' : '' }}>
                                                        Restaurant</option>
                                                    <option value="Banner"
                                                    ...
                                                    <option value="Reports"
                                                        {{ $permission->group_name == 'Reports' ? 'selected' : '' }}>Reports
                                                    </option>
                                                    <option value="Review"
                                                        {{ $permission->group_name == 'Review' ? 'selected' : '' }}>Review
                                                    </option>
                                                    <option value="Admins"
                                                        {{ $permission->group_name == 'Admins' ? 'selected' : '' }}>Admins
                                                    </option>
                                                    <option value="Roles&permissions"
                                                        {{ $permission->group_name == 'Roles&permissions' ? 'selected' : '' }}>
                                                        Roles&permissions
                                                    </option>Roles&permissions
                                                </select>
                                            </div>
