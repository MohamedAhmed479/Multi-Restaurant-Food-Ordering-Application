                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <form method="POST" action="{{ route('client.verification.send') }}">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="p-2 mt-4">
                                                ...
                                                <p>We have sent you verification email <span class="fw-bold">{{ Auth::guard('client')->user()->email }}</span>, Please check it</p>
                                                <div class="mt-4">
                                                    <!-- تحويل الرابط إلى زر -->
                                    ...
                                    <div class="mt-5 text-center">
                                        <p class="text-muted mb-0"> Are You Need To Logout? <a href="{{Route('client.logout')}}"
                                                class="text-primary fw-semibold"> Logout Now </a> </p>
                                    </div>
