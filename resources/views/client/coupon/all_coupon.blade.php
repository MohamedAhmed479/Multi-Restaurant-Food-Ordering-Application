                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <a href="{{ route('client.coupons.add') }}"
                                    class="btn btn-primary waves-effect waves-light">Add Coupon</a>
                            </ol>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($coupons as $key => $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('client.coupons.edit', ['coupon' => $item]) }}"
                                                    class="btn btn-info waves-effect waves-light">Edit</a>
                                                <a href="{{ route('client.coupons.destroy', ['coupon' => $item]) }}"
