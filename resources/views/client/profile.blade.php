                            ...
                            <div class="row">
                                                ...
                                                <select name="city_id" class="form-select">
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            {{ $city->id == $profileData->city_id ? 'selected' : '' }}>
                                                            {{ $city->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mt-3 mt-lg-0">
                                        ...
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Profile Photo</label>
                                            <input class="form-control" name="photo" type="file" id="image2">
                                        </div>
