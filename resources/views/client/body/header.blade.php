@php
    ...
    $profileData1 = App\Models\Client::find($clientId);
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        @foreach ($user->notifications as $notification)
                            ...
                            <a href="{{ Route('client.order.details', ['order' => $order]) }}"
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="{{ !empty($profileData1->photo) ? asset("upload/client_images/$profileData1->photo") : asset('upload/no_image.jpg') }}"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ $profileData1->name }}</span>
